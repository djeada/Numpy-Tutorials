...
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------- | --------------------- |
| **Mean**                   | $\bar x = \frac{1}{N}\sum\_{i=1}^N x\_i$                                                                                                        | `np.mean(a)`                             | `import numpy as np`<br>`a = np.array([1,2,3,4,5])`<br>`np.mean(a)`                            | `3.0`                 |
...
| **Correlation** $\rho$   | $\rho\_{xy}=\frac{\mathrm{cov}(x,y)}{\sigma\_x,\sigma\_y}$                                                                                      | `np.corrcoef(x,y)`                       | `import numpy as np`<br>`x = np.array([1,2,3])`<br>`y = np.array([4,5,6])`<br>`np.corrcoef(x,y)` | `[[1. 1.]\n [1. 1.]]` |
